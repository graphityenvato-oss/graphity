...
const animationTitle = () => {
  ...
  if (typeof window !== "undefined") {
    ...
    // If user scrolls fast before triggers initialize, make sure visible items show.
    revealIfInView(".anim_heading_title");
    revealIfInView(".anim_text_writting");
    revealIfInView(".anim_word_writting");
    revealIfInView(".anim_text");
    revealIfInView(".anim_div_ShowZoom");
    revealIfInView(".anim_div_ShowLeftSide");
    revealIfInView(".anim_div_ShowRightSide");
    revealIfInView(".anim_div_ShowDowns");
    revealIfInView(".anim_div_ShowUps");
    revealIfInView(".anim_text_popup");
  }

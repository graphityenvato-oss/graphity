...
const ContactArea = () => {
  return (
    <>
      <section className="cs_contact_page">
        <div className="container">
          <div className="cs_contact_ms">
            ...
            <div className="cs_contact_section_2 anim_div_ShowRightSide">
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d207.8037028040269!2d35.405923605424476!3d33.557033224143304!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2slb!4v1769515505293!5m2!1sen!2slb"
                ...
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">+961 70 25 95 90</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">info@graphitylb.com</p>
                    </div>
                  </div>
                </div>
              </div>

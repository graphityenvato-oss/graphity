...
const HeaderOne = () => {
  ...
  return (
    <>
      <header
        className={`cs_site_header cs_style1 cs_sticky_header cs_site_header_full_width ${sticky ? "cs_gescout_sticky" : ""} ${lightHeader ? "cs_header_light" : ""}`}
      >
          ...
          <div className="container">
            <div className="cs_main_header_in">
              ...
              <div className="cs_main_header_right">
                ...
                <ThemeToggle className="cs_theme_toggle" />
              </div>
            </div>
          </div>
        </div>

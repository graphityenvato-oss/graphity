...
const footer_data: DataType = {
  email: `info@graphitylb.com`,
  phone: `+961 70 25 95 90`,
  location: `Lebanon, Saida, Majdelyoun`,
  footer_info: `We are problem solvers with a keen interest in contributing to society through design. Let our passion lead your success.`,
  links: [
    { title: `HOME`, link: "/" },
